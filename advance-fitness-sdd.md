...
| 12 | Pivote SaaS white-label: negocio (12a implementada, agosto 2026 — landing de autoservicio con cobro manual, ver Nota 24) | por definir (post-piloto) | Modelo de Escalada (§17.2): tiers Starter/Pro con límites y contadores de uso de IA por tenant, pasarela de pagos online, tier Partnership con revenue share y medición de ventas por tenant; tácticas go-to-market de §17.3 según mercado (gimnasios, influencers, agencias white-label) | Un tenant contrata y paga online un tier; los límites de IA del tier Starter se aplican de verdad; existe al menos un tenant Partnership con liquidación de revenue share verificable |
...
> Estado: **landing implementada con cobro manual (agosto 2026, Fase 12a — ver Nota 24).** El resto de la visión (pasarela de pago online, aprovisionamiento automático) sigue documentado, no implementado. Responde a la idea de Cesar de vender el sistema directo a entrenadores y separar a las personas individuales — refina §17.1 con dos canales *product-led* (autoservicio, sin comercializador humano) que complementan la venta asistida, para escalar ingreso sin escalar headcount.
...
**Dos bugs latentes encontrados de paso (ninguno introducido por esta fase, ambos en producción antes de este cambio):**
...
**Pendiente, explícito:** pasarela de pago online, aprovisionamiento automático del tenant/usuario al pagar, y la decisión de revisión de plan del segmento individual (§17.5 arriba) — los tres siguen sin resolver; esta fase solo valida demanda con el costo de construcción más bajo posible.
